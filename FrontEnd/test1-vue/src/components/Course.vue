...
export default {
  ...
  methods: {
    ...
    createCode(){
      // 去获取支付连接
      this.axios
        .get("http://localhost:9000/pay/order/createCode",{
          params:{
        ...
        .then((result) => {
          ...
          // 检查支付状态
          this.axios
            .get("http://localhost:9000/pay/order/checkOrderStatus",{
              params:{
    ...
    saveOrder(){
      return this.axios
        .get("http://localhost:9000/order/order/saveOrder",{
          params:{
    ...
    updateOrder(statusCode){
      return this.axios
        .get("http://localhost:9000/order/order/updateOrder",{
          params:{
            orderNo:this.orderNo,
            status:statusCode,
          }
    ...
    getComment(){
      return this.axios
      .get("http://localhost:9000/comment/course/comment/getCourseCommentList/"+this.course.id+"/1/20")
      .then((result) => {
    ...
    saveComment(){
       return this.axios
        .get("http://localhost:9000/comment/course/comment/saveCourseComment",{
          params:{
            courseid:this.course.id,
    ...
    getMyCourseList(){ 
       return this.axios
      .get("http://localhost:9000/order/order/getOKOrderCourseIds/"+this.user.content.id)
      .then((result) => {
...
console.log("我购买过的课程："+this.myCourseIds);
    ...
    zan(comment){        
      return this.axios
      .get("http://localhost:9000/comment/course/comment/saveFavorite/"+comment.id+"/"+this.user.content.id)
      .then((result) => {
        // console.log(result);
        // 重新获取本门课的全部留言信息
        this.getComment();
    ...
    cancelzan(comment){
      return this.axios
      .get("http://localhost:9000/comment/course/comment/cancelFavorite/"+comment.id+"/"+this.user.content.id)
      .then((result) => {
        // console.log(result);
        // 重新获取本门课的全部留言信息
        this.getComment();
